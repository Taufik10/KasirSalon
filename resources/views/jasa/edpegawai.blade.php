...
<h3 class="page-title">
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Edit Pegawai</h4>
                            <div class="tools">
            ...
            <form class="cmxform form-horizontal" action="{{ $pegawai->id }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">      
                             <div class="control-group ">
                                    <label for="lastname" class="control-label">Nama Stylist</label>    
                                    <div class="controls">       
                                    <input style="width:250px;" type="text" name="nama" value="{{ $pegawai->nama }}">
                                  </div>
                               </div>
                             <div class="control-group ">
                                    ...
                                    <select style="width:100%;height:35px;" name="kategori_jasa">
                                      @foreach($kategoris as $key => $kategori)
                                        @if($kategori->id == $pegawai->kategori_jasa)
